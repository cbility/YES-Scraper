...
var getLoginDetails_mjs_1 = require("./RHI/getLoginDetails.mjs");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    browser = _a.sent();
                    return [4 /*yield*/, (0, getLoginDetails_mjs_1.default)(loginID, browser)];
                case 2:
                    _a.sent();
...
//# sourceMappingURL=RHI-local.mjs.map